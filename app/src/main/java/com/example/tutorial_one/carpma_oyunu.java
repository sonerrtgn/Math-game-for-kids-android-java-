...
public class carpma_oyunu extends AppCompatActivity implements View.OnClickListener{
    Button[] siklar;
    soru sorulacak;
    TextView soru_text;
    TextView puan_text;
        ...
        for(Button i:siklar){
            if (v.getId() == i.getId()) {
                ...
                if(puan == 10){
                    ...
                    int simdiki_carpma_leveli = guncelleme.carp_level_kac();
                    guncelleme.carp_level_degistir(simdiki_carpma_leveli+1);
                    Intent geri_don = new Intent(carpma_oyunu.this,carpma_seviyeleri.class);
                    guncelleme.kapat();
